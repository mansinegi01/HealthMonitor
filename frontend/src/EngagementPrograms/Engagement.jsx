...
// // Fires a gentle daily nudge at a configurable hour for goals and gratitude.
// // Runs once on mount; re-schedules itself for the next day via setTimeout.
// function useDailyReminders() {
//   useEffect(() => {
//     if (typeof Notification === "undefined") return;
//     if (Notification.permission !== "granted") return;

//     const GOALS_HOUR = 9;      // 09:00 — morning goals reminder
//     const GRATITUDE_HOUR = 21; // 21:00 — evening gratitude reminder

//     const scheduleReminder = (label, body, hour, tag) => {
//       const now = new Date();
...
//         scheduleReminder(label, body, hour, tag);
//       }, delay);
//     };

//     const goalsId = scheduleReminder(
//       "◎ Goals check-in",
//       "Don't break your streak — tap to check in today's goals.",
//       GOALS_HOUR,
//       "daily-goals"
//     );
//     const gratitudeId = scheduleReminder(
//       "✦ Gratitude moment",
//       "Take 2 minutes to write what you're grateful for today.",
//       GRATITUDE_HOUR,
//       "daily-gratitude"
//     );

//     return () => {
//       clearTimeout(goalsId);
//       clearTimeout(gratitudeId);
//     };
//   }, []);
// }
...
//   // Wire up daily goal + gratitude nudge notifications
//   useDailyReminders();
...
//                 color: "#e8eaf2", letterSpacing: "-0.02em", margin: 0,
//               }}>
...
//           {/* Tab Bar */}
//           <div style={{
//             display: "flex", gap: 4, background: "#13161e", padding: 4,
//             borderRadius: 14, border: "1px solid #232840", marginBottom: 16,
//           }}>
//             {TABS.map((tab) => (
//               <button
//                 key={tab.id}
//                 className="eng-tab-btn"
...
export default function Engagement() {
  ...
  return (
    <>
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Syne:wght@400;600;700;800&family=DM+Sans:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500;700&display=swap');
        html, body, #root { height: 100%; overflow-y: auto !important; }
        .eng-tab-btn { transition: all .2s; }
        .eng-tab-btn:hover { background: #181c27 !important; color: #e8eaf2 !important; }
        textarea:focus { border-color: #7ee8a2 !important; box-shadow: 0 0 0 3px #7ee8a220 !important; }
        input:focus { border-color: #7ee8a2 !important; box-shadow: 0 0 0 3px #7ee8a220 !important; }
      ...
      <div style={{
        background: "#0d0f14", minHeight: "100vh", padding: "24px 16px 80px 16px",
        fontFamily: "DM Sans, sans-serif", overflowY: "auto", boxSizing: "border-box",
      }}>
        <div style={{ maxWidth: 560, margin: "0 auto" }}>
          {/* Page Header */}
          <div style={{ marginBottom: 24 }}>
